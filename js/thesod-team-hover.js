	...
	$(function(){
		...
		$('.sod-team').each(function() {
			...
			$('.team-person', $team).each(function() {
				...
				if($('a.team-person-link',$teamPerson).length || $team.hasClass('sod-team-style-5')) {
					...
					$teamPerson.on('mouseenter', function() {
						if(hoverColors.background_color) {
							if($team.hasClass('sod-team-style-5')) {
								...
								if($team.hasClass('sod-team-style-1') || $team.hasClass('sod-team-style-6')) {
							...
							if($team.hasClass('sod-team-style-2') || $team.hasClass('sod-team-style-3') || $team.hasClass('sod-team-style-4')) {
					...
					$teamPerson.on('mouseleave', function() {
						...
						if($team.hasClass('sod-team-style-5') && hoverColors.background_color) {
