...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class($thesod_classes); ?><?php echo (!empty($item_colors['additional_background_color']) ? ' style="background-color: '.esc_attr($item_colors['additional_background_color']).'"' : ''); ?>>
					...
					<div class="post-misc">
						<div class="post-author">
							...
							<?php if($thesod_categories): ?>
								<span class="post-meta-categories"><?php echo esc_html__( "in ", "thesod" ) . implode('<span class="sep"></span>', $thesod_categories_list); ?></span>
							<?php endif ?>
						</div>
